...
# Instala o TurboVNC, se especificado
...
# Variáveis de ambiente para Scala e SBT
ARG SCALA_VERSION
...
# Instala SBT
RUN curl -fsL --show-error "https://github.com/sbt/sbt/releases/download/v$SBT_VERSION/sbt-$SBT_VERSION.tgz" | \
    tar xfz - -C /usr/share && \
